...
# Added this script to try lexical-playground as individial react app
# As of 2025.05.13, it works totally fine (npm run dev from playground dir)
# Should be used regularly to bring updates from source repo
#
